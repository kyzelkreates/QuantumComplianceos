...
const RUNS_COMPLETE = [
  ...
  { run: 17,    label: 'Final Commercial Polish + Full System Validation + Deployment Readiness',
    desc: 'DeploymentReadiness.jsx: 8 new sections (product identity, demo/live/backend explanation, commercial upgrade path, AI agent explanation, backend safety, 30-item validation checklist, portfolio readiness). responsive.css: Run 15-17 mobile fixes. docs/DEPLOYMENT_CHECKLIST_RUN_17.md. v17.0.0.' },
